...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyAty9UYAtsoL9wJTWFx3i-QXelXMGW892w';
    try {
...
//    final expiryDate = DateTime.parse(extractedUserData['expiryDate']);
//    if (expiryDate.isBefore(DateTime.now())) { //expiryDate.isAfter
//      return false;
//    }
//    _token = extractedUserData['token'];
//    _userId = extractedUserData['userId'];
////    _expiryDate = expiryDate; //_expiryDate = extractedUserData['expiryDate']
